...
const createSingleChats = async (numChats) => {
    try {
        ...
        consol.log("chats created successfully");
        process.exit();
    } catch (error) {
        console.error(error);
        process.exit(1);
...
const createMessage = async (numMessages) => {
    try {
        ...
        consol.log("message created successfully");
        process.exit();
    } catch (error) {
        console.error(error);
        process.exit(1);
...
export { createGroupChats, createMessage, createMessageInChat, createSingleChats };
